...
static uint32 EXP_ID = 0;
static u16 srampage = 0;
uint32 cExpansion::ReadNorFlashID(void)
{
...
void cExpansion::ChipReset()
{
	*((vu16 *)(FlashBase)) = 0xF0 ;
	*((vu16 *)(FlashBase+0x1000*2)) = 0xF0 ;

	if(EXP_ID==0x227E2202)
	{
...
void cExpansion::Block_Erase(u32 blockAdd)
{
	...
	u32 loop;
	u32 off=0;
	if( (blockAdd>=0x1000000) &&  (EXP_ID==0x227E2202))
	{
		off=0x1000000;
...
void cExpansion::WriteNorFlash(u32 address,const u8* buffer,u32 size)
{
		...
		v1=0;v2=1;
		u32 off=0;
		if( (address>=0x1000000) &&  (EXP_ID==0x227E2202))
		{
			off=0x1000000;
		}
		else
